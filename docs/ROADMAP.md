...
- [ ] An actual design system — color palette, spacing scale, and component styling expressed as CSS custom properties/tokens, not one-off hardcoded values. The palette is tokens already (`--fm-*`, 25 colors); spacing, radii and component styling aren't.
