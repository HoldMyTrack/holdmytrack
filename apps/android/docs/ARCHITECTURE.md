...
| :--- | :--- |
| In-app GPS recording | `apps/android/docs/ROADMAP.md` Phase 7 ships it — planned, not a "never" (`docs/VISION.md` §4.1); see the scope note above and [ADR-0007](../../../docs/adr/0007-in-app-gps-recording-submits-directly.md) |
